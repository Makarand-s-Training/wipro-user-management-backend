 ...
 *
 * <p><strong>INTENTIONALLY VULNERABLE APPLICATION FOR DEMO/TRAINING PURPOSES</strong>
 *
 * <p>This application demonstrates common security vulnerabilities and technical debt:
 * <ul>
 ...
 * </ul>
 *
 * <p><strong>WARNING: DO NOT USE THIS APPLICATION IN PRODUCTION!</strong>
 * <p>This is for educational and demonstration purposes only.
 *
 * <p>Application runs on port configured via environment variable PORT or defaults to 8080.
 *
 * <p>Example startup:
 * <pre>
 * mvn clean package
...
@OpenAPIDefinition(
    info = @Info(
        title = "User Management API (Vulnerable Demo)",
        version = "1.0",
        description = """
    ...
    servers = {
        ...
        @Server(url = "http://localhost:${PORT}", description = "Configurable Port Server")
    }
)
